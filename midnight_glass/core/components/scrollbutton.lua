...
local function setUpBaseButton(button, state)
	...
	normalTexture:SetTexture("Interface\\AddOns\\midnight_glass\\assets\\scroll-buttons")
	...
	pushedTexture:SetTexture("Interface\\AddOns\\midnight_glass\\assets\\scroll-buttons")
